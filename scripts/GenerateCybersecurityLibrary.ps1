...
$librarySitePath = "$env:userprofile\Documents\GitHub\Cybersecurity-Library\docs"
...
$json = $allPubs | ConvertTo-Json -Depth 4
...
$markdown | Out-File -FilePath "$librarySitePath\README.md" -Encoding UTF8 -NoNewline -Force 
